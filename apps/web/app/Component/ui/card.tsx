...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-lg font-semibold p-1 leading-none tracking-tight",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn(
      "text-sm pt-1  text-neutral-500 dark:text-neutral-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex pt-4 items-center px-6 pb-6", className)}
    {...props}
  />
));
